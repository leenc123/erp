    ...
    <a-modal :title="batchTitle" v-model="batchVisible" width="750px" cancelText="关闭" :maskClosable="false"
      ...
      <a-table rowkey="id" :columns="columnsBatch" :data-source="stockCheckBatchItems" :pagination="false"
        ...
        <div slot="actual_quantity" slot-scope="value, item">
          <a-input-number :value="item.actual_quantity" min="1"
            @change="(value) => changeQuantityBatch(value, item, 'actual_quantity')" />
        </div>
        <div slot="batch_number" slot-scope="value, item">
          <a-select v-model="item.batch_number" @change="(e) => changeQuantityBatch(e, item, 'batch_number')"
            style="width: 100%">
        ...
        <div slot="production_date" slot-scope="value, item">
          <a-date-picker :value="item.production_date" valueFormat="YYYY-MM-DD"
