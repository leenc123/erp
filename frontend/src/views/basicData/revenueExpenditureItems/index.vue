...
<script>
  ...
  import { revenueExpenditureItemsExport } from '@/api/export'
  import { revenueExpenditureItemsTemplate, revenueExpenditureItemsImport } from '@/api/import'
  import { revenueExpenditureItemsList, revenueExpenditureItemsDestroy } from '@/api/basicData'
  ...
  export default {
    ...
    methods: {
      ...
      list() {
        this.loading = true;
        revenueExpenditureItemsList(this.searchForm).then(data => {
